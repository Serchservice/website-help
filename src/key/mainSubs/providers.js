...
export const ProviderSubCategories = () => {
    const { id } = useParams();
    ...
    useEffect(() => {
        let category = HelpCategoryLinks.find(help => help.id === 'providers');
                    ...
                    <div className="keyHeader">
                        <div className="keyHead">
                            <div className="rowLinks">
                                ...
                                <Link to={`/${HelpLinks.providers}/${id}`} className="rowLink"> {subCategory.title} </Link>
                            </div>
                        </div>
                            ...
                            >
                                ...
                                </div>
                                {
                                    link.subLinks.map((item, index) => {
                                        return <Link to={`/${HelpLinks.providers}/${id}/section/${item.id}`} key={index}
